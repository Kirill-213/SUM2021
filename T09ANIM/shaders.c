»спользование и загрузка шейдеров
ќсновы использовани€ шейдверов на GLSL

ѕримеры шейдеров:
!!! соглашени€:
шейдера одной шейдерной программ располагаютс€ в отдельной директории и называютс€ одинаково:
/bin/shaders/default/
  vert.glsl
  frag.glsl
/bin/shaders/land/
...
// выходные параметры - цвет рисовани€
...
«агрузка шейдеров
  ...
  attach shaders
  link
  --> ProgId Ц целочисленный номер шейдерной программы

ѕодключение при рисовании
